...
function makeRandomEditAndGetChange(cm, delayMs) {
    ...
    return new Promise(function (resolve, reject$$1) {
        ...
        while (isEqual(pos2, pos1))
            pos2 = getRandomPosition(cm);
        var replaceWith = randomString(Math.round(Math.random() * 10), "wxyz\n");
        // let replaceWith = "";
...
function setRandomContent(cm) {
    cm.operation(function () {
        ...
        for (var line = 0; line < 25; line += 1) {
            ...
            var contents = randomString(lineLength, "abcdef");
...
function testChanges(cm, originalContent, change1, change2) {
    ...
    var composedChange = composeChanges(cm, change1, change2);
...
var TestRunner = /** @class */ (function () {
    ...
    TestRunner.runRandomTests = function (repeats, delay) {
        ...
        // setAlphabeticalContent(cm);
        var originalContent = cm.getValue();
        makeRandomEditAndGetChange(cm, delay).then(function (change1) {
            makeRandomEditAndGetChange(cm, delay).then(function (change2) {
